...
const Hero = () => {
  return (
    ...
    <div className="hero-action">
        ...
        <div className="hero-resume"> <a href="https://alfafza.github.io/resume/"  className=" text-white no-underline" target="_blank" rel="noopener noreferrer">My Resume</a></div>
    </div>
    </div>
  )
}
